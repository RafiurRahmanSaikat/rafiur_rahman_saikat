...
const DotGridHeroSection = () => {
  ...
  return (
    <section
      id="home"
      ref={sectionRef}
      className="relative min-h-screen w-full overflow-hidden bg-gradient-to-b from-zinc-100 to-white pt-16 dark:from-zinc-900 dark:to-zinc-950"
    >
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 32 32' width='40' height='40' strokewidth='' fill='none' stroke='%23334155' strokeOpacity='0.2' strokeDasharray='5 3' strokeLinecap='round' strokeLinejoin='round'%3e%3cpath d='M0 .5H31.5V32'/%3e%3c/svg%3e\")",
          backgroundSize: "40px 40px",
        }}
      />

      {/* Animated gradient blobs - parallax effect with mouse movement */}
      <div
        className="absolute left-1/4 top-1/4 h-96 w-96 -translate-x-1/2 -translate-y-1/2 rounded-full bg-blue-400/20 blur-3xl filter dark:bg-blue-600/10"
        style={{
      ...
      />
      <div
        className="absolute right-1/4 bottom-1/4 h-96 w-96 -translate-x-1/2 -translate-y-1/2 rounded-full bg-purple-400/20 blur-3xl filter dark:bg-purple-600/10"
        style={{
          transform: `translate(calc(-50% - ${mousePosition.x * 0.02}px), calc(-50% - ${mousePosition.y * 0.02}px))`,
          transition: "transform 0.2s ease-out",
        }}
      ...
      <div className="container relative z-10 mx-auto flex min-h-screen flex-col items-center justify-center px-4 py-20 sm:px-6 lg:px-8">
        ...
        <div className="mb-4 flex items-center justify-center">
          <span className="inline-flex items-center rounded-full border border-zinc-200 bg-white/80 px-3 py-1 text-sm font-medium text-zinc-800 backdrop-blur-sm dark:border-zinc-800 dark:bg-zinc-900/80 dark:text-zinc-200">
            <svg
      ...
      <AnimatedLines />
      <AnimatedGridPattern containerRef={sectionRef} />
    </section>
  )
}
export default DotGridHeroSection